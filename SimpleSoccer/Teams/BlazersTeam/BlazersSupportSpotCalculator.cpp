...
//------------------------------- dtor ----------------------------------------
//-----------------------------------------------------------------------------
BlazersSupportSpotCalculator::~BlazersSupportSpotCalculator()
{
  delete m_pRegulator;
}
...
//------------------------------- ctor ----------------------------------------
//-----------------------------------------------------------------------------
BlazersSupportSpotCalculator::BlazersSupportSpotCalculator(int           numX,
                             int              numY,
...
//-----------------------------------------------------------------------------
Vector2D BlazersSupportSpotCalculator::DetermineBestSupportingPosition()
{
  ...
  for (curSpot = m_Spots.begin(); curSpot != m_Spots.end(); ++curSpot)
  {
    ...
    {
      const double OptimalDistance = 100.0;//200.0;
...
//-----------------------------------------------------------------------------
Vector2D BlazersSupportSpotCalculator::GetBestSupportingSpot()
{
...
//----------------------------------- Render ----------------------------------
//-----------------------------------------------------------------------------
void BlazersSupportSpotCalculator::Render()const
{
    gdi->HollowBrush();
    gdi->GreyPen();
