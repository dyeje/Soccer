...
//------------------------------- dtor ----------------------------------------
//-----------------------------------------------------------------------------
Prior__SupportSpotCalculator::~Prior__SupportSpotCalculator()
{
  delete m_pRegulator;
}
...
//------------------------------- ctor ----------------------------------------
//-----------------------------------------------------------------------------
Prior__SupportSpotCalculator::Prior__SupportSpotCalculator(int           numX,
                             int              numY,
...
//----------------------------------- Render ----------------------------------
//-----------------------------------------------------------------------------
void Prior__SupportSpotCalculator::Render()const
{
    gdi->HollowBrush();
    gdi->GreyPen();
